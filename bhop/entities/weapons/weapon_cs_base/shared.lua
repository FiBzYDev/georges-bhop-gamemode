...
function SWEP:Deploy()
		...
		self.Owner:SetWalkSpeed(BHOP.GunWalkSpeed)
		self.Owner:SetMaxSpeed(BHOP.GunWalkSpeed)
return true
end

function SWEP:Holster()
	self.Owner:SetWalkSpeed(BHOP.WalkSpeed)
	self.Owner:SetWalkSpeed(BHOP.WalkSpeed)
return true
end
/*---------------------------------------------------------
...
local CCrosshair = CreateClientConVar( "cl_crosshair", "1", true, false )
local CGap = CreateClientConVar( "cl_cross_gap", "1", true, false )
local CThick = CreateClientConVar( "cl_cross_thick", "0", true, false )
local CLength = CreateClientConVar( "cl_cross_length", "2", true, false )
local CColorR = CreateClientConVar( "cl_cross_color_r", "50", true, false )
local CColorG = CreateClientConVar( "cl_cross_color_g", "250", true, false )
local CColorB = CreateClientConVar( "cl_cross_color_b", "0", true, false )
local CColorA = CreateClientConVar( "cl_cross_opacity", "200", true, false )
